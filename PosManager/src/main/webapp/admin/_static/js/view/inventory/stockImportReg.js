...
define([
  ...
  'text!templates/inventory/stockImportReg.html',
...
//        }).draw();
    ...
    form_init : function(method, $modal){
		...
		$('#timepicker1').daterangepicker({
	  	      ...
	  	      startDate: JC_init_value.firstMonthDay("from-date"),
	  	      endDate: JC_init_value.lastMonthDay("to-date")
	  		},
