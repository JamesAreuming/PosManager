...
//    	}
    	...
    	_catId = $("#category_select").val();

		$.ajax({
			url : itemsSelect,
			data : {
				data : JSON.stringify({ brandId : _data.brandId, storeId : _data.storeId, catId : _catId })
			},
			success : function(result){
				if(result.success){
    ...
    addGridly : function (event){
		...
		var addLi = "<li class='ui-state-default' id='li_"+_Id+"'>"+
				...
				"<p class='data-box-b'>"+itemPrice+"</p>"+
...
//    	}
    	...
    	$.ajax({
			...
			data : {
				...
				data : JSON.stringify({ brandId : _data.brandId, storeId : _data.storeId , catId : _pluId})
			},
			success : function(result){
				if(result.success){
					alert(i18n.BO4046);
    ...
    setPluItemGridly : function (pluItemList){
    	...
    	$.each(pluItemList, function(idx, data){
    		...
    		var addLi = "<li class='ui-state-default' id='li_"+data.itemId+"'>"+
						...
						"<p class='data-box-b'>"+data.price+"</p>"+
