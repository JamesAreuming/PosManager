...
define([
  ...
  'text!templates/inventory/stockExportManage.html',
  ...
  var targetUrl = './model/inventory/StockExport';
  ...
  var ContentView = Backbone.View.extend({
    ...
    datatablesInit : function(){
    	datatables = $("#stockExport-tables").DataTable({
	  		"serverSide": true,
	    	"language": {
		    ...
		    "columns" : [
		      { "data" : "YMD", "name" : "YMD", render: function (data, type, row) {return Common.JC_format.day(data);} },
			  { "data" : "ITEM_CD", "name" : "ITEM_CD"},
			  { "data" : "ITEM_NM", "name" : "ITEM_NAME", "className" : "dt-left"},
			  { "data" : "VALUE", "name" : "VALUE", render: function (data, type, row) {return Common.JC_format.number(data);}, "className" : "dt-right"}
			],
	        "order": [[ 0, 'desc' ]],
		    "pageLength": 10,
		    "lengthChange": false,
