/*
 * Filename	: categorySalesManage.js
 * Function	:
 * Comment 	:
 * History	: 
 *
...
define([
		  ...
		  ,'text!templates/sales/categorySalesManage.html'
		  ,'text!templates/sales/cateSalesChartAndData.html'
  ...
  var targetUrl = './model/sales/CategorySales';
	        	...
	        	var lineChart = new FusionCharts({
    				...
    				'dataSource': {
    					'chart': {
    						...
    						'xAxisName': i18n.BO1014,
    						'yAxisName': i18n.BO2303,
    						'theme': 'fint',
//    						"numberprefix": i18n.BO0030,
    				        'exportEnabled': '1'
    					},
    					'data': charData.CateSalesTop5Chart
    				}
    			});
    		lineChart.render();
...
//    						"numberprefix": i18n.BO0030,
	        	...
	        	$.each(dayMonthData,function(idx, value){
	        		...
	        		_dayMonCate[idx] = temp;
	        		data = { "seriesname" : dayMonthData[idx].catNm, "data" : _dayMonCate[idx] };
	        		_dayMonData.push(data);
	        	});
...
//                        	"slantlabels": "1"
	        	...
	        	$.each(charData.weekChart,function(idx, value){
	        		var temp = [];
	        		var data = {};
	        		$.each(charData.weekChart[idx],function(label, value){
	        			if(label != "" && label != undefined){
	        				if(label != "catNm"){
		        				var _cObj = {};
		        	    		_cObj.value = value;
	        		...
	        		_weeklyCate[idx] = temp;
	        		data = { "seriesname" : charData.weekChart[idx].catNm, "data" : _weeklyCate[idx] };
	        		_weeklyMonData.push(data);
//	        	     "seriesname": charData.weekChart[0].catNm,
//                     "data": _weeklyCate[0]
...
//	                        "numberprefix": i18n.BO0030,
	        	...
	        	$.each(charData.hourChart,function(idx, value){
	        		...
	        		_hourCate[idx] = temp;
	        		data = { "seriesname" : charData.hourChart[idx].catNm, "data" : _hourCate[idx] };
	        		_hourData.push(data);
	        	});
