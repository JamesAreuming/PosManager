...
define([
  ...
  'text!templates/reward/stampManage.html',
  'text!templates/reward/stamp_list_modal.html',

  'bootstrap-daterangepicker'

], function (Backbone, Mustache, moment, Common, i18n, template, modal) {
  'use strict';
