...
define([
  ...
  'text!templates/nine/beaconManage.html',
  'text!templates/nine/modal/beacon_form.html',
  'text!templates/nine/modal/beacon_csv.html',
  ...
  var targetUrl = './model/nine/Beacon';
...
//    	} ).draw();
    ...
    csvUp: function () {
        ...
        if (confirm(i18n.BO4013)) {
            $('#csvUpForm').attr('action', './model/nine/BeaconCsv');
       		var options = {
