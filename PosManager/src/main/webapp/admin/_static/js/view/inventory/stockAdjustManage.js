...
define([
  ...
  'text!templates/inventory/stockAdjustManage.html',
  ...
  var targetUrl = './model/inventory/StockAdjust';
  ...
  var ContentView = Backbone.View.extend({
    ...
    datatablesInit : function(){
    	datatables = $("#stockAdjust-tables").DataTable({
	  		"serverSide": true,
	    	"language": {
		    ...
		    "columns" : [
		      { "data" : "created", "name" : "CREATED", render: function (data, type, row) {return Common.JC_format.day(data);}},
			  { "data" : "itemCd", "name" : "ITEM_CD"},
			  { "data" : "itemNm", "name" : "ITEM_NM"},
			  { "data" : "safeCnt", "name" : "SAFE_CNT", render: function (data, type, row) {return Common.JC_format.number(data);} },
			  { "data" : "currentCnt", "name" : "CURRENT_CNT", "className" : "current-cnt",  render: function (data, type, row) {return Common.JC_format.number(data);} },
			  { "data" : "actualCnt", "name" : "ACTUAL_CNT", render: function (data, type, row) {return Common.JC_format.number(data);} },
			  { "data" : "gapCnt", "name" : "GAP_CNT", "className" : "gapCnt", render: function (data, type, row) {return Common.JC_format.number(data);} }
			],
    	...
    	$.ajax({
    		...
    		success : function(response){
    			if(response.success){
    		        ...
    		        data.i18n = i18n;
    		        data = JC_format.handleData(data);
