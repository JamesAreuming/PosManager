...
define([
  ...
  'text!templates/sysmanage/userManage.html',
  'i18n!templates/globals/lang/nls/language',
  
  'text!templates/sysmanage/modal/user_modal.html',
  
  'text!templates/sysmanage/modal/modal_form_alert.html'
  
], function (Backbone, Mustache, template, i18n, modalform, modalAlert) {
  'use strict';
  
  var targetUrl = './model/User';
