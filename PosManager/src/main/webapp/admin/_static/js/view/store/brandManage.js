...
define([
  ...
  'text!templates/store/brandManage.html',
  'text!templates/store/modal/brandmodal.html',
  ...
  var targetUrl = "./model/store/Brand";
	        	...
	        	$.ajax({
	        		...
	        		success : function(response) {
	        			if (response.success) {
							...
							if (_file.files[0]) {
								_data.append("_file_brand_", _file.files[0]);
								_data.append("gubun", "brand");
