...
define([
    ...
    'text!templates/reward/couponSumManage.html',
    'text!templates/reward/couponSumChartAndData.html',
    ...
    var targetUrl = './model/reward/CouponSum';
...
//						$('#be-search').remove();
	    ...
	    tableHtml: function (data, option1) {
			...
			$.each(data, function(idx, val) {
	    		if (idx > 0) {
	    			if (idx == 1 || idx == 4 || idx == 7 || idx == 10) html += '<tr class="odd gradeX back_blue">';
	    ...
	    convertChart : function(data) {
        	...
        	var dayMonthChart = new FusionCharts({
        		...
        		dataSource: {
        	        ...
        	        "categories": [{
        	            "category": data.dayMonthChart1
        	        }],
        	        "dataset": [{
        	            "seriesname": i18n.BO2189,
        	            "data": data.dayMonthChart1
        	        	}, {
        	            "seriesname": i18n.BO2270,
        	            "data": data.dayMonthChart2
        	        	}, {
    	        		"seriesname": i18n.BO2355,
    	        		"data": data.dayMonthChart3
        	        }]
        		}
        	});
        	...
        	var dayofweekChart = new FusionCharts({
        		...
        		dataSource: {
        	        ...
        	        "categories": [{
        	            "category": data.dayofweekValueChart1
        	        }],
        	        "dataset": [{
        	            "seriesname": i18n.BO2189,
        	            "data": data.dayofweekValueChart1
        	        	}, {
        	            "seriesname": i18n.BO2270,
        	            "data": data.dayofweekValueChart2
        	        }]
        		}
        	});
        	...
        	var hourChart = new FusionCharts({
        		...
        		dataSource: {
        	        ...
        	        "categories": [{
        	            "category": data.hourValueChart1
        	        }],
        	        "dataset": [{
        	            "seriesname": i18n.BO2189,
        	            "data": data.hourValueChart1
        	        	}, {
        	            "seriesname": i18n.BO2270,
        	            "data": data.hourValueChart2
        	        }]
        		}
        	});
        	hourChart.render();
