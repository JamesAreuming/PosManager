...
<script src="https://getbootstrap.com/offcanvas.js"></script> 


    <div class="twain_container" style="width: 0%; height: 0%;">
        <!--
            Register listener
            var $c = $($('#popup_iframe').contents()[0]);
            $('body', $c).on('DOMNodeInserted', '#thumbnail_chain', function (e) {
                console.log('Receive image');
            });
        -->
        <iframe id="popup_iframe" frameborder="0" style="width: 100%; height:100%;"></iframe>
    </div>
</body>
