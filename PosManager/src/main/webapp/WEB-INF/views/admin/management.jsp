...
<head>
  ...
  <link href="${basePath}${basePathEmpty}_static/assets/plugins/bootstrap-checkbox/css/awesome-bootstrap-checkbox.css" rel="stylesheet" type="text/css"/>
  <link href="${basePath}${basePathEmpty}_static/assets/plugins/summernote-master/summernote.css" rel="stylesheet" type="text/css"/>
