...
public class SureM {
	...
	public static void main(String[] args) {
		...
		SendReport sr = ims.sendMain(
                ...
                java.lang.String callphone,
                java.lang.String reqname,
                java.lang.String reqphone1,
                java.lang.String reqphone2,
                java.lang.String reqphone3,
                java.lang.String callmessage,
                java.lang.String rdate,
                java.lang.String rtime,
                java.lang.String encodeFlag);
				...
				callphone - 수신자 번호
				reqname - 수신자 명
				reqphone1 - 발신자 번호1 (02)
				reqphone2 - 발신자 번호2 (1588)
				reqphone3 - 발신자 번호3 (4640)
				callmessage - 메시지 내용
				rdate - 예약날짜 yyyyMMdd ("00000000" -> 즉시전송)
				rtime - 예약시간 HHmmss
				encodeFlag - UTF-16 인코딩 여부 "U"
                */
		SendReport sr = ims.sendMain(
				100, // int member,
