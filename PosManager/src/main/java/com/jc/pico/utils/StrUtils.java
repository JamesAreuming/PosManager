...
public class StrUtils {
	...
	*/
	...
	public static Map<String, String> getStartWithParam(Map<String, String> obj, String s){
	...
	public static Map<String, Object> convertCamelcase(Map<String, Object> map) {
  ...
  public static String toNumberOnly(String val) {
	    if (val == null || val.trim().length() == 0) {return val;}
	    
	    return val.replaceAll("\\D", "");
	}
  
  public static boolean toIpRegex(String val) {
